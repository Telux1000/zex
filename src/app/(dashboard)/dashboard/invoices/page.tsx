...
import { InvoicesCsvExportButton } from '@/components/invoices/InvoicesCsvExportButton';
...
export default async function InvoicesPage() {
  ...
  if (invoiceTablePerfEnabled()) {
    invoiceTablePerfLog('summary', `rsc_auth_business_customers_ms=${Date.now() - rscT0}`);
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Suspense fallback={null}>
            <InvoicesCsvExportButton businessId={business.id} />
          </Suspense>
          <Link
